...
if __name__ == '__main__':
    # pytest.main(['-s', 'test_Get_ApplicationList.py'])
    pytest.main(['-s', 'test_Get_ApplicationList.py::TestGetApplicationList::test_121001_get_0index_without_login'])
