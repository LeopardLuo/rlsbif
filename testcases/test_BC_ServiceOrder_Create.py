...
class TestCreateServiceOrder(object):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            with allure.step("获取测试URI值。"):
                cls.URI = cls.config.getItem('uri', 'INCreate')
            ...
            with allure.step("user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "123456789",
                        "imei": "460011234567890", "phone": "13511222242", "sms_code": "123456",
            ...
            with allure.step("teststep: get features id."):
                ...
                cls.feature_id = feature_data[0]['features_id']
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id, "feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
            ...
            with allure.step("teststep5: get service order list"):
    ...
    def test_201003_business_order_id_correct(self, business_order_id, result):
        ...
        :param result: expect result.
        """
        self.logger.info(".... Start test_201003_business_order_id_correct ({}) ....".format(business_order_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_201003_business_order_id_correct ({}) ....".format(business_order_id))
            self.logger.info("")
    ...
    def test_201005_member_id_wrong(self, member_id, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": member_id,"feature_id": self.feature_id,"device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
    ...
    @allure.severity("critical")
    @allure.story("错误spu_id值")
    @allure.testcase("FT-HTJK-201-006")
    @pytest.mark.parametrize("spu_id, result",
                             [('1' * 1001, {"status": 200, "code": 202005, "msg": ""}),
                              (0, {"status": 200, "code": 202005, "msg": ""}),
                              (-9223372036854775809, {"status": 200, "code": 202005, "msg": ""}),
                              (9223372036854775808, {"status": 200, "code": 202005, "msg": ""}),
                              (-1, {"status": 200, "code": 202005, "msg": ""}),
                              (1.5, {"status": 200, "code": 202005, "msg": ""}),
                              ('a', {"status": 200, "code": 202005, "msg": ""}),
                              ('中', {"status": 200, "code": 202005, "msg": ""}),
                              ('*', {"status": 200, "code": 202005, "msg": ""}),
                              ('1a', {"status": 200, "code": 202005, "msg": ""}),
                              ('1中', {"status": 200, "code": 202005, "msg": ""}),
                              ('1*', {"status": 200, "code": 202005, "msg": ""}),
                              (' ', {"status": 200, "code": 202005, "msg": ""}),
                              ('', {"status": 200, "code": 202005, "msg": ""})],
                             ids=["spu_id(超长值)", "spu_id(0)", "spu_id(超小值)", "spu_id(超大值)", "spu_id(-1)",
                                  "spu_id(小数)", "spu_id(字母)", "spu_id(中文)", "spu_id(特殊字符)",
                                  "spu_id(数字字母)", "spu_id(数字中文)", "spu_id(数字特殊字符)", "spu_id(空格)",
                                  "spu_id(空)"])
    def test_201006_spu_id_wrong(self, spu_id, result):
        """ Test wrong spu_id values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-201-006).
        :param spu_id: spu_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_201006_spu_id_wrong ({}) ....".format(spu_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id,"device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": spu_id, "service_unit": 'unit1', "service_address": 'dept1',
                         "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_201006_spu_id_wrong ({}) ....".format(spu_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误feature_id值")
    @allure.testcase("FT-HTJK-201-007")
    @pytest.mark.parametrize("feature_id, result",
                             [('1' * 1001, {"status": 400, "code": 0, "msg": ""}),
                              (0, {"status": 200, "code": 101007, "msg": "feature_id值非法"}),
                              (1, {"status": 200, "code": 101007, "msg": "feature_id值非法"}),
                              (9223372036854775807, {"status": 200, "code": 202007, "msg": "客户特征不存在"}),
                              (-1, {"status": 200, "code": 101007, "msg": "feature_id值非法"}),
                              (1.0, {"status": 200, "code": 101007, "msg": "feature_id值非法"}),
                              ...
                              (' ', {"status": 400, "code": 0, "msg": ""}),
                              ('', {"status": 400, "code": 0, "msg": ""})],
                             ids=["feature_id(超长值)", "feature_id(0)", "feature_id(最小值)", "feature_id(最大值)",
                                  "feature_id(-1)", "feature_id(小数)", "feature_id(超大)", "feature_id(字母)",
                                  "feature_id(中文)", "feature_id(特殊字符)", "feature_id(数字字母)",
                                  "feature_id(数字中文)", "feature_id(数字特殊字符)", "feature_id(空格)", "feature_id(空)"])
    def test_201007_feature_id_wrong(self, feature_id, result):
        """ Test wrong feature_id values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-201-007).
        :param feature_id: feature_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_201007_feature_id_wrong ({}) ....".format(feature_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_201007_feature_id_wrong ({}) ....".format(feature_id))
            self.logger.info("")
    ...
    @pytest.mark.parametrize("device_ids, result",
                             ...
                             ids=["device_ids(1个)", "device_ids(多个)"])
    def test_201008_device_ids_correct(self, device_ids, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": device_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         ...
                         "end_time": 9999999999, "in_count": 1, "spu_id": random.randint(100000, 1000000),
                         "service_unit": 'unit1', "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_201010_verify_condition_type_correct ({}) ....".format(verify_condition_type))
            self.logger.info("")
    ...
    def test_201012_begin_time_correct(self, begin_time, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": begin_time, "end_time": 9999999999,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201013_begin_time_wrong(self, begin_time, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": begin_time, "end_time": 5555555555,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201014_end_time_correct(self, end_time, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": 1, "end_time": end_time,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201015_end_time_wrong(self, end_time, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id,"device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": get_timestamp(), "end_time": end_time,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201016_check_time_empty(self, check_time, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id,"device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": check_time, "end_time": check_time,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": in_count, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201019_in_count_empty(self, in_count, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 1, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": in_count, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         ...
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": service_unit,
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id,"device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'test',
                         "service_address": service_address,  "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         ...
                         "verify_condition_type": 3, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'test',
                         "service_address": 'dept1', "timestamp": timestamp}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201028_no_member_id(self):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
    ...
    @allure.severity("critical")
    @allure.story("缺少spu_id参数")
    @allure.testcase("FT-HTJK-201-029")
    def test_201029_no_spu_id(self):
        """ Test create service order without spu_id(FT-HTJK-201-029)."""
        self.logger.info(".... Start test_201029_no_spu_id ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_201029_no_spu_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少feature_id参数")
    @allure.testcase("FT-HTJK-201-030")
    def test_201030_no_feature_id(self):
        """ Test create service order without feature_id(FT-HTJK-201-030)."""
        self.logger.info(".... Start test_201030_no_feature_id ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_201030_no_feature_id ....")
            self.logger.info("")
    ...
    def test_201031_no_device_ids(self):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id, "feature_id": self.feature_id,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
    ...
    def test_201033_no_begin_time(self, condition_type, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id,"device_ids": self.devices_ids,
                         "verify_condition_type": condition_type, "end_time": 9999999999,
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'test',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201034_no_end_time(self, condition_type, result):
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": condition_type, "begin_time": get_timestamp(),
                         "in_count": 10, "spu_id": random.randint(100000, 1000000), "service_unit": 'test',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": condition_type, "begin_time": get_timestamp(),
                         "end_time": 9999999999, "spu_id": random.randint(100000, 1000000), "service_unit": 'test',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,  "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id, "feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_address": 'dept1',
                         "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
        ...
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id, "feature_id": self.feature_id, "device_ids": self.devices_ids,
                         "verify_condition_type": 3, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'test',
                         "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
                self.logger.info("data: {0}".format(datas))
    ...
    def test_201001_create_service_order_owner(self):
        ...
        try:
            ...
            with allure.step("teststep3: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
                         "member_id": self.member_id,"feature_id": user_features, "device_ids": self.devices_ids,
                         "verify_condition_type": 2, "begin_time": get_timestamp(), "end_time": 9999999999,
                         "in_count": 1, "spu_id": random.randint(100000, 1000000), "service_unit": 'unit1',
                         "service_address": 'dept1', "timestamp": get_timestamp()}
                allure.attach("params value", "{0}".format(datas))
...
if __name__ == '__main__':
    # pytest.main(['-s', 'test_BC_ServiceOrder_Create.py'])
    pytest.main(['-s', 'test_BC_ServiceOrder_Create.py::TestCreateServiceOrder::test_201001_create_service_order_owner'])
