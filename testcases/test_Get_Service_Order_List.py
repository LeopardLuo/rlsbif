...
if __name__ == '__main__':
    pytest.main(['-s', 'test_Get_Service_Order_List.py'])
    # pytest.main(['-s', 'test_Get_Service_Order_List.py::TestCetServiceOrderList::test_119024_no_timestamp'])
