...
class TestCloseServiceOrder(object):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            with allure.step("获取测试URI值。"):
                cls.URI = cls.config.getItem('uri', 'INClose')
            ...
            with allure.step("user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "123456789",
                        "imei": "460011234567890", "phone": "13511222282", "sms_code": "123456",
    ...
    def setup_method(self, method):
        ...
        with allure.step("teststep: create service orders"):
            order_result = inner_create_service_order(self.httpclient, self.system_id, str(random.randint(1000, 100000)),
                                                   self.member_id, self.features_id, self.devices_ids, 3,
                                                   get_timestamp(), 9999999999, 10, random.randint(1000, 100000), 'testunit',
    ...
    @allure.testcase("FT-HTJK-209-001")
    def test_209001_cancel_service_order_correct(self):
        """ Test cancel service order by correct parameters(FT-HTJK-209-001)."""
        self.logger.info(".... Start test_209001_cancel_service_order_correct ....")
        try:
            ...
            self.logger.info(".... End test_209001_cancel_service_order_correct ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误system_id值")
    @allure.testcase("FT-HTJK-209-002")
    ...
    def test_209002_system_id_wrong(self, system_id, result):
        """ Test wrong system_id values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-209-002).
        :param system_id: system_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_209002_system_id_wrong ({}) ....".format(system_id))
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_209002_system_id_wrong ({}) ....".format(system_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误service_order_id值")
    @allure.testcase("FT-HTJK-209-003")
    ...
    def test_209003_service_order_id_wrong(self, service_order_id, result):
        """ Test wrong service_order_id values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-209-003).
        :param service_order_id: service_order_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_209003_service_order_id_wrong ({}) ....".format(service_order_id))
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_209003_service_order_id_wrong ({}) ....".format(service_order_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确close_code值")
    @allure.testcase("FT-HTJK-209-004")
    @pytest.mark.parametrize("close_code, result",
                             [(0, {"code": 1, "msg": 3}),
                              (1, {"code": 1, "msg": 5})],
                             ids=["close_code(0)", "close_code(1)"])
    def test_209004_close_code_correct(self, close_code, result):
        """ Test correct close_code values (0/1）(FT-HTJK-209-004).
        :param close_code: close_code parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_209004_close_code_correct ({}) ....".format(close_code))
        try:
            with allure.step("teststep1: get parameters."):
                json = {"system_id": self.system_id, "service_order_id": self.service_order_id,
                        "close_code": close_code, "timestamp": get_timestamp()}
                headers = {"authorization": None}
                allure.attach("params value", "{0}, {1}".format(json, headers))
                self.logger.info("data: {0}, headers: {1}".format(json, headers))
            ...
            self.logger.info(".... End test_209004_close_code_correct ({}) ....".format(close_code))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误close_code值")
    @allure.testcase("FT-HTJK-209-005")
    @pytest.mark.parametrize("close_code, result",
                             [(-1, {"status": 200, "code": 101017, "msg": "close_code值非法"}),
                              ...
                              (' ', {"status": 400, "code": 0, "msg": ""}),
                              ('', {"status": 400, "code": 0, "msg": ""})],
                             ids=["close_code(-1)", "close_code(2)", "close_code(超小值)", "close_code(超大值)",
                                  "close_code(小数)",
                                  "close_code(字母)", "close_code(中文)", "close_code(特殊字符)", "close_code(数字字母)",
                                  "close_code(数字中文)", "close_code(数字特殊字符)", "close_code(空格)", "close_code(空)"])
    def test_209005_close_code_wrong(self, close_code, result):
        """ Test wrong close_code values (-1、5、-2147483649、2147483648、1.0、字母、中文、特殊字符、数字字母、数字中文、
            数字特殊字符、空格、空）(FT-HTJK-209-005).
        :param close_code: close_code parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_209005_close_code_wrong ({}) ....".format(close_code))
        try:
            with allure.step("teststep1: get parameters."):
                json = {"system_id": self.system_id, "service_order_id": self.service_order_id,
                        "close_code": close_code, "timestamp": get_timestamp()}
            ...
            self.logger.info(".... End test_209005_close_code_wrong ({}) ....".format(close_code))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确timestamp值")
    @allure.testcase("FT-HTJK-209-006")
    @pytest.mark.parametrize("timestamp, result",
                             [(get_timestamp() - 100, {"code": 1, "msg": ""}),
                              (get_timestamp() + 100, {"code": 1, "msg": ""})],
                             ids=["timestamp(最小值)", "timestamp(最大值)"])
    def test_209006_timestamp_correct(self, timestamp, result):
        """ Test correct timestamp values (最小值、最大值）(FT-HTJK-209-006).
        :param timestamp: timestamp parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_209006_timestamp_correct ({}) ....".format(timestamp))
        try:
            with allure.step("teststep1: get parameters."):
                json = {"system_id": self.system_id, "service_order_id": self.service_order_id,
                        "close_code": 1, "timestamp": timestamp}
                headers = {"authorization": None}
                allure.attach("params value", "{0}, {1}".format(json, headers))
                self.logger.info("data: {0}, headers: {1}".format(json, headers))
            ...
            self.logger.info(".... End test_209006_timestamp_correct ({}) ....".format(timestamp))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误timestamp值")
    @allure.testcase("FT-HTJK-209-007")
    @pytest.mark.parametrize("timestamp, result",
    ...
    def test_209007_timestamp_wrong(self, timestamp, result):
        """ Test wrong timestamp values (1、9223372036854775807、0、-1、允许超小值、允许超大值、-9223372036854775809、9223372036854775808、1.0、
            字母、中文、特殊字符、数字字母、数字中文、数字特殊字符、空格、空）(FT-HTJK-209-007).
        :param timestamp: timestamp parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_209007_timestamp_wrong ({}) ....".format(timestamp))
        try:
            with allure.step("teststep1: get parameters."):
                json = {"system_id": self.system_id, "service_order_id": self.service_order_id,
                        "close_code": 1, "timestamp": timestamp}
            ...
            self.logger.info(".... End test_209007_timestamp_wrong ({}) ....".format(timestamp))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少system_id参数")
    @allure.testcase("FT-HTJK-209-008")
    def test_209008_no_system_id(self):
        """ Test close service order without system_id(FT-HTJK-209-008)."""
        self.logger.info(".... Start test_209008_no_system_id ....")
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_209008_no_system_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少service_order_id参数")
    @allure.testcase("FT-HTJK-209-009")
    def test_209009_no_service_order_id(self):
        """ Test close service order without service_order_id(FT-HTJK-209-009)."""
        self.logger.info(".... Start test_209009_no_service_order_id ....")
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_209009_no_service_order_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少close_code参数")
    @allure.testcase("FT-HTJK-209-010")
    def test_209010_no_close_code(self):
        """ Test close service order without close_code(FT-HTJK-209-010)."""
        self.logger.info(".... Start test_209010_no_close_code ....")
        try:
            with allure.step("teststep1: get parameters."):
                json = {"system_id": self.system_id, "service_order_id": self.service_order_id,
                        "timestamp": get_timestamp()}
            ...
            self.logger.info(".... End test_209010_no_close_code ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少timestamp参数")
    @allure.testcase("FT-HTJK-209-011")
    def test_209011_no_timestamp(self):
        """ Test close service order without timestamp(FT-HTJK-209-011)."""
        self.logger.info(".... Start test_209011_no_timestamp ....")
        try:
            with allure.step("teststep1: get parameters."):
                json = {"system_id": self.system_id, "service_order_id": self.service_order_id,
                        "close_code": 1}
            ...
            self.logger.info(".... End test_209011_no_timestamp ....")
            self.logger.info("")


if __name__ == '__main__':
    # pytest.main(['-s', 'test_BC_ServiceOrder_Close.py'])
    pytest.main(['-s', 'test_BC_ServiceOrder_Close.py::TestCloseServiceOrder::test_209011_no_timestamp'])
