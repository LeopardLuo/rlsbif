...
class TestOrderDelete(object):
    ...
    @allure.story("下本人服务单，删除本人服务单")
    @allure.testcase("FT-HTJK-204-001")
    def test_204001_delete_apply_result_user_order(self):
        """ Test order delete interface delete apply result user order. """
        self.logger.info(".... Start test_204001_delete_apply_result_user_order ....")
        try:
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_204001_delete_apply_result_user_order ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("下访客服务单，删除所有服务单")
    @allure.testcase("FT-HTJK-204-002")
    def test_204002_delete_add_visitor_result_all_order(self):
        """ Test order delete interface delete add visitor result all order. """
        self.logger.info(".... Start test_204002_delete_add_visitor_result_all_order ....")
        try:
            with allure.step("teststep1: user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "12345678901"*4,
                        "imei": "460011234567890", "phone": "13511229000", "sms_code": "123456",
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_204002_delete_add_visitor_result_all_order ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("下访客服务单，删除本人服务单")
    @allure.testcase("FT-HTJK-204-003")
    def test_204003_delete_add_visitor_result_user_relate_other(self):
        """ Test order delete interface delete add visitor result user order. """
        self.logger.info(".... Start test_204003_delete_add_visitor_result_user_relate_other ....")
        try:
            with allure.step("teststep1: user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "12345678901"*4,
                        "imei": "460011234567890", "phone": "13511229000", "sms_code": "123456",
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_204003_delete_add_visitor_result_user_relate_other ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("下访客服务单，删除访客服务单")
    @allure.testcase("FT-HTJK-204-004")
    def test_204004_delete_add_visitor_result_only_other_order(self):
        """ Test order delete interface delete add visitor result only other order. """
        self.logger.info(".... Start test_204004_delete_add_visitor_result_only_other_order ....")
        try:
            with allure.step("teststep1: user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "12345678901"*4,
                        "imei": "460011234567890", "phone": "13511229000", "sms_code": "123456",
            ...
            with allure.step("teststep10: create service orders"):
                ...
                with allure.step("邀请访客下单"):
                    r_applyresult1 = h5_shopping_add_visitor_result(httpclient1, provider_id, spu_id, sku_id,
                                                                    "kuli1", time.strftime("%Y-%m-%d"), "2021-02-10",
                                                                    "relate_face.jpg", self.logger)
                    allure.attach("apply result", str(r_applyresult1))
                    self.logger.info("apply result: " + str(r_applyresult1))
                    assert r_applyresult1
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_204004_delete_add_visitor_result_only_other_order ....")
            self.logger.info("")
    ...
    def test_204005_order_delete_providerId_wrong(self, providerId, result):
        """ Test wrong providerId values (FT-HTJK-204-005).
        :param providerId: providerId parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_204005_order_delete_providerId_wrong ({}) ....".format(providerId))
        try:
            with allure.step("teststep1: user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "12345678901"*4,
                        "imei": "460011234567890", "phone": "13511229000", "sms_code": "123456",
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_204005_order_delete_providerId_wrong ({}) ....".format(providerId))
            self.logger.info("")
    ...
    @pytest.mark.parametrize("productId, result",
                             ...
                             ids=["productId(超长值)", "productId(小数)", "productId(英文)","productId(中文)",
                                  ...
                                  "productId(0)", "productId(超大)", "productId(超小)"])
    def test_204006_order_delete_productId_wrong(self, productId, result):
        """ Test wrong productId values (FT-HTJK-204-006).
        :param productId: productId parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_204006_order_delete_productId_wrong ({}) ....".format(productId))
        try:
            with allure.step("teststep1: user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "12345678901"*4,
                        "imei": "460011234567890", "phone": "13511229000", "sms_code": "123456",
            ...
            with allure.step("teststep12: delete order."):
                with allure.step("teststep: get order id."):
                    ...
                    order_id = select_result[0][0]
                with allure.step("teststep: get parameters."):
                    data = {"providerId": provider_id, "productId": productId, "skuId": sku_id, "orderId": order_id}
                    allure.attach("params value", "{0}".format(data))
                    self.logger.info("data: {0}".format(data))
                with allure.step("teststep: requests http get."):
                    rsp = httpclient1.get(self.URI, params=data)
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_204006_order_delete_productId_wrong ({}) ....".format(productId))
            self.logger.info("")
        ...
        try:
            ...
            with allure.step("teststep12: delete order."):
                with allure.step("teststep: get order id."):
                    ...
                    order_id = select_result[0][0]
                with allure.step("teststep: get parameters."):
                    data = {"providerId": provider_id, "productId": spu_id, "skuId": skuId, "orderId": order_id}
                    allure.attach("params value", "{0}".format(data))
                    self.logger.info("data: {0}".format(data))
                with allure.step("teststep: requests http get."):
                    rsp = httpclient1.get(self.URI, params=data)
    ...
    @pytest.mark.parametrize("orderId, result",
                             [(0, {"status": 200, "code": '1', "msg": "删除成功"}),
                              ...
                              (-2, {"status": 200, "code": '1', "msg": "删除成功"}),
                              (-10000, {"status": 200, "code": '1', "msg": "删除成功"}),
        ...
        try:
            ...
            with allure.step("teststep12: delete order."):
                with allure.step("teststep: get order id."):
                    ...
                    order_id = select_result[0][0]
                with allure.step("teststep: get parameters."):
                    data = {"providerId": provider_id, "productId": spu_id, "skuId": sku_id, "orderId": orderId}
                    allure.attach("params value", "{0}".format(data))
                    self.logger.info("data: {0}".format(data))
                with allure.step("teststep: requests http get."):
                    rsp = httpclient1.get(self.URI, params=data)
    ...
    @pytest.mark.parametrize("orderId, result",
                             [('1' * 256, {"status": 200, "code": 97, "msg": "参数格式不正确"}),
                              ...
                              (' ', {"status": 200, "code": 97, "msg": "参数格式不正确"}),
                              ('', {"status": 200, "code": 97, "msg": "参数格式不正确"}),
                              (1, {"status": 200, "code": '300', "msg": "删除失败"}),
                              (9223372036854775808, {"status": 200, "code": 97, "msg": "参数格式不正确"}),
                              (-9223372036854775809, {"status": 200, "code": 97, "msg": "参数格式不正确"})],
                             ids=["orderId(超长值)", "orderId(小数)", "orderId(英文)", "orderId(中文)",
        ...
        try:
            ...
            with allure.step("teststep12: delete order."):
                with allure.step("teststep: get order id."):
                    ...
                    order_id = select_result[0][0]
                with allure.step("teststep: get parameters."):
                    data = {"productId": spu_id, "skuId": sku_id, "orderId": order_id}
                    allure.attach("params value", "{0}".format(data))
                    self.logger.info("data: {0}".format(data))
                with allure.step("teststep: requests http get."):
                    rsp = httpclient1.get(self.URI, params=data)
                ...
                with allure.step("teststep: assert the response content"):
                    ...
                    assert "输入信息非法" in rsp_content["message"]
        ...
        try:
            ...
            with allure.step("teststep12: delete order."):
                with allure.step("teststep: get order id."):
                    ...
                    order_id = select_result[0][0]
                with allure.step("teststep: get parameters."):
                    data = {"providerId": provider_id, "skuId": sku_id, "orderId": order_id}
                    allure.attach("params value", "{0}".format(data))
                    self.logger.info("data: {0}".format(data))
                with allure.step("teststep: requests http get."):
                    rsp = httpclient1.get(self.URI, params=data)
        ...
        try:
            ...
            with allure.step("teststep12: delete order."):
                with allure.step("teststep: get order id."):
                    ...
                    order_id = select_result[0][0]
                with allure.step("teststep: get parameters."):
                    data = {"providerId": provider_id, "productId": spu_id, "orderId": order_id}
                    allure.attach("params value", "{0}".format(data))
                    self.logger.info("data: {0}".format(data))
                with allure.step("teststep: requests http get."):
                    rsp = httpclient1.get(self.URI, params=data)
