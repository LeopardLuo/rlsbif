...
class TestOrderDelete(object):
    ...
    @allure.severity("critical")
    @allure.story("下常驻人员服务单，删除所有服务单")
    @allure.testcase("FT-HTJK-xxx-xxx")
    def test_delete_add_member_other_all_order(self):
        """ Test order delete interface delete add memeber other all order. """
        ...
        try:
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_delete_add_member_other_all_order ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("下访客服务单，删除所有服务单")
    @allure.testcase("FT-HTJK-xxx-xxx")
    def test_delete_add_visitor_result_all_order(self):
        ...
        try:
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_delete_add_visitor_result_all_order ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("下拜访服务单，删除拜访服务单")
    @allure.testcase("FT-HTJK-xxx-xxx")
    ...
    @allure.severity("critical")
    @allure.story("下常驻人员服务单，删除常驻人员服务单")
    @allure.testcase("FT-HTJK-xxx-xxx")
    def test_delete_add_member_result_only_other_order(self):
        """ Test order delete interface delete add memeber result only other order. """
        ...
        try:
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_delete_add_member_result_only_other_order ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("下访客服务单，删除访客服务单")
    @allure.testcase("FT-HTJK-xxx-xxx")
    def test_delete_add_visitor_result_only_other_order(self):
        ...
        try:
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_delete_add_visitor_result_only_other_order ....")
            self.logger.info("")
    ...
    def test_order_delete_productId_wrong(self, productId, result):
        ...
        try:
            ...
            with allure.step("teststep: delete insert user info"):
                ...
                allure.attach("delete result", str(delete_result))
                self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_order_delete_productId_wrong ({}) ....".format(productId))
            self.logger.info("")
...
if __name__ == '__main__':
    ...
    pytest.main(['-s', 'test_H5_Order_Delete.py::TestOrderDelete::test_order_delete_without_orderid'])
