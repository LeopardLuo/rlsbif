    ...
    def setup_class(cls):
        ...
        try:
            ...
            with allure.step("获取测试URI值。"):
                cls.URI = cls.config.getItem('uri', 'H5CreateServiceOrder')
...
if __name__ == '__main__':
    # pytest.main(['-s', 'test_H5_ServiceOrder_Create.py'])
    pytest.main(['-s', 'test_H5_ServiceOrder_Create.py::TestCreateServiceOrder::test_201001_create_service_order_owner'])
