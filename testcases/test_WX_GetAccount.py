...
class TestGetWXAcount(object):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            with allure.step("获取测试URI值。"):
                cls.URI = cls.config.getItem('uri', 'AccountList')
            ...
            with allure.step("user register."):
                json = {"code_type": 0, "client_type": 1, "client_version": "v1", "device_token": "123456789",
                        "imei": "460011234567890", "phone": "13511222151", "sms_code": "123456",
    ...
    @allure.story("正确获取账号列表")
    @allure.testcase("FT-HTJK-114-001")
    def test_114001_get_acount_correct(self):
        """ Test get account by correct parameters(FT-HTJK-114-001)."""
        self.logger.info(".... Start test_114001_get_acount_correct ....")
        try:
            ...
            self.logger.info(".... End test_114001_get_acount_correct ....")
            self.logger.info("")
    ...
    def test_114002_token_wrong(self, token, result):
        """ Test wrong token values (超长值、1.0、中文、特殊字符、数字中文、数字特殊字符、空格、空）(FT-HTJK-114-002).
        :param token: token parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_114002_token_wrong ({}) ....".format(token))
        try:
            with allure.step("teststep1: get parameters."):
                params = {"member_id": self.member_id, "timestamp": get_timestamp()}
            ...
            self.logger.info(".... End test_114002_token_wrong ({}) ....".format(token))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误member_id值")
    @allure.testcase("FT-HTJK-114-003")
    ...
    def test_114003_member_id_wrong(self, member_id, result):
        """ Test wrong member_id values (超长值、1.0、中文、特殊字符、数字中文、数字特殊字符、空格、空）(FT-HTJK-114-003).
        :param member_id: member_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_114003_member_id_wrong ({}) ....".format(member_id))
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_114003_member_id_wrong ({}) ....".format(member_id))
            self.logger.info("")
    ...
    def test_114004_timestamp_correct(self, timestamp, result):
        ...
        :param result: expect result.
        """
        self.logger.info(".... Start test_114004_timestamp_correct ({}) ....".format(timestamp))
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_114004_timestamp_correct ({}) ....".format(timestamp))
            self.logger.info("")
    ...
    def test_114005_timestamp_wrong(self, timestamp, result):
        """ Test wrong timestamp values (1、9223372036854775807、0、-1、-9223372036854775809、9223372036854775808、1.0、
            字母、中文、特殊字符、数字字母、数字中文、数字特殊字符、空格、空）(FT-HTJK-114-005).
        :param timestamp: timestamp parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_114005_timestamp_wrong ({}) ....".format(timestamp))
        try:
            with allure.step("teststep1: get parameters."):
                params = {"member_id": self.member_id, "timestamp": timestamp}
                headers = {"authorization": self.token}
            ...
            self.logger.info(".... End test_114005_timestamp_wrong ({}) ....".format(timestamp))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少token参数")
    @allure.testcase("FT-HTJK-114-006")
    def test_114006_no_token(self):
        """ Test get account list without token(FT-HTJK-114-006)."""
        self.logger.info(".... Start test_114006_no_token ....")
        try:
            with allure.step("teststep1: get parameters."):
                params = {"member_id": self.member_id, "timestamp": get_timestamp()}
            ...
            self.logger.info(".... End test_114006_no_token ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少member_id参数")
    @allure.testcase("FT-HTJK-114-007")
    def test_114007_no_member_id(self):
        """ Test get account list without member_id(FT-HTJK-114-007)."""
        self.logger.info(".... Start test_114007_no_member_id ....")
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_114007_no_member_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少timestamp参数")
    @allure.testcase("FT-HTJK-114-008")
    def test_114008_no_timestamp(self):
        """ Test get account list without timestamp(FT-HTJK-114-008)."""
        self.logger.info(".... Start test_114008_no_timestamp ....")
        try:
            with allure.step("teststep1: get parameters."):
            ...
            self.logger.info(".... End test_114008_no_timestamp ....")
            self.logger.info("")


if __name__ == '__main__':
    pytest.main(['-s', 'test_WX_GetAccount.py'])
    # pytest.main(['-s', 'test_WX_GetAccount.py::TestGetWXAcount::test_114008_no_timestamp'])
