...
class TestBSCreateServiceOrder(object):
    ...
    @allure.testcase("FT-HTJK-207-001")
    def test_207001_create_service_order_owner(self):
        """ Test create service order of owner(FT-HTJK-207-001)."""
        self.logger.info(".... Start test_207001_create_service_order_owner ....")
        service_order_id = None
        try:
            ...
            with allure.step("teststep2: get user features id."):
                user_info = bs_get_user_info(self.httpclient, self.system_id, self.member_id, business_token,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207001_create_service_order_owner ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误system_id值")
    @allure.testcase("FT-HTJK-207-002")
    ...
    def test_207002_system_id_wrong(self, system_id, result):
        """ Test wrong system_id values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-207-002).
        :param system_id: system_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207002_system_id_wrong ({}) ....".format(system_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207002_system_id_wrong ({}) ....".format(system_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确business_order_id值")
    @allure.testcase("FT-HTJK-207-003")
    ...
    def test_207003_business_order_id_correct(self, business_order_id, result):
        """ Test correct business_order_id values (1.0、超大值、字母、中文、特殊字符、数字字母、数字中文、数字特殊字符）(FT-HTJK-207-003).
        :param business_order_id: business_order_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207003_business_order_id_correct ({}) ....".format(business_order_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207003_business_order_id_correct ({}) ....".format(business_order_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误business_order_id值")
    @allure.testcase("FT-HTJK-207-004")
    @pytest.mark.parametrize("business_order_id, result",
    ...
    def test_207004_business_order_id_wrong(self, business_order_id, result):
        """ Test wrong business_order_id values (超长值、空格、空）(FT-HTJK-207-004).
        :param business_order_id: business_order_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207004_business_order_id_wrong ({}) ....".format(business_order_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": business_order_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207004_business_order_id_wrong ({}) ....".format(business_order_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误system_code值")
    @allure.testcase("FT-HTJK-207-005")
    ...
    def test_207005_system_code_wrong(self, system_code, result):
        """ Test wrong system_code values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-207-005).
        :param system_code: system_code parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207005_system_code_wrong ({}) ....".format(system_code))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207005_system_code_wrong ({}) ....".format(system_code))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误features_id值")
    @allure.testcase("FT-HTJK-207-006")
    ...
    def test_207006_features_id_wrong(self, features_id, result):
        """ Test wrong member_id values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-207-006).
        :param features_id: features_id parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207006_features_id_wrong ({}) ....".format(features_id))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207006_features_id_wrong ({}) ....".format(features_id))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确device_ids值")
    @allure.testcase("FT-HTJK-207-007")
    @pytest.mark.parametrize("device_ids, result",
                             [(1, {"status": 200, "code": 1, "msg": ""}),
                              (2, {"status": 200, "code": 1, "msg": ""})],
                             ids=["device_ids(超长值)", "device_ids(0)"])
    def test_207007_device_ids_correct(self, device_ids, result):
        """ Test correct device_ids values (最小值、最大值）(FT-HTJK-207-007).
        :param device_ids: device_ids parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207007_device_ids_correct ({}) ....".format(device_ids))
        service_order_id = None
        if device_ids == 1:
        ...
        try:
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207007_device_ids_correct ({}) ....".format(device_ids))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误device_ids值")
    @allure.testcase("FT-HTJK-207-008")
    @pytest.mark.parametrize("device_ids, result",
                             [(['1' * 1001], {"status": 400, "code": 0, "msg": ""}),
                             ...
                             ids=["device_ids(超长值)", "device_ids(0)", "device_ids(最小值)", "device_ids(最大值)",
                                  ...
                                  "device_ids(数字字母)",
                                  "device_ids(数字中文)", "device_ids(数字特殊字符)", "device_ids(空格)", "device_ids(空)",
                                  "device_ids(非数组)"])
    def test_207008_device_ids_wrong(self, device_ids, result):
        """ Test wrong device_ids values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-207-008).
        :param device_ids: device_ids parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207008_device_ids_wrong ({}) ....".format(device_ids))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207008_device_ids_wrong ({}) ....".format(device_ids))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确verify_condition_type值")
    @allure.testcase("FT-HTJK-207-009")
    ...
    def test_207009_verify_condition_type_correct(self, verify_condition_type, result):
        """ Test correct verify_condition_type values (1/2/3）(FT-HTJK-207-009).
        :param verify_condition_type: verify_condition_type parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207009_verify_condition_type_correct ({}) ....".format(verify_condition_type))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207009_verify_condition_type_correct ({}) ....".format(verify_condition_type))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误verify_condition_type值")
    @allure.testcase("FT-HTJK-207-010")
    @pytest.mark.parametrize("verify_condition_type, result",
                             ...
                             ids=["verify_condition_type(-1)", "verify_condition_type(0)", "verify_condition_type(5)",
                                  ...
                                  "verify_condition_type(字母)", "verify_condition_type(中文)",
                                  "verify_condition_type(特殊字符)",
                                  "verify_condition_type(数字字母)", "verify_condition_type(数字中文)",
                                  "verify_condition_type(数字特殊字符)", "verify_condition_type(空格)",
                                  "verify_condition_type(空)"])
    def test_207010_verify_condition_type_wrong(self, verify_condition_type, result):
        """ Test wrong verify_condition_type values (-1、5、-2147483649、2147483648、1.0、字母、中文、特殊字符、数字字母、数字中文、
            数字特殊字符、空格、空）(FT-HTJK-207-010).
        :param verify_condition_type: verify_condition_type parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207010_verify_condition_type_wrong ({}) ....".format(verify_condition_type))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207010_verify_condition_type_wrong ({}) ....".format(verify_condition_type))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确begin_time值")
    @allure.testcase("FT-HTJK-207-011")
    @pytest.mark.parametrize("begin_time, result",
                             [(1, {"status": 200, "code": 1, "msg": ""}),
                              (9999999998, {"status": 200, "code": 1, "msg": ""})],
                             ids=["begin_time(最小值)", "begin_time(最大值)"])
    def test_207011_begin_time_correct(self, begin_time, result):
        """ Test correct begin_time values (最小值、最大值）(FT-HTJK-207-011).
        :param begin_time: begin_time parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207011_begin_time_correct ({}) ....".format(begin_time))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207011_begin_time_correct ({}) ....".format(begin_time))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误begin_time值")
    @allure.testcase("FT-HTJK-207-012")
    @pytest.mark.parametrize("begin_time, result",
                             [('1' * 1001, {"status": 400, "code": 0, "msg": ""}),
                             ...
                             ids=["begin_time(超长值)", "begin_time(0)", "begin_time(最大值)",
                                  ...
                                  "begin_time(数字中文)", "begin_time(数字特殊字符)", "begin_time(空格)", "begin_time(空)",
                                  "begin_time(比end大)"])
    def test_207012_begin_time_wrong(self, begin_time, result):
        """ Test wrong begin_time values (超长值、0、最小值、最大值、-1、1.0、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空）(FT-HTJK-207-012).
        :param begin_time: begin_time parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207012_begin_time_wrong ({}) ....".format(begin_time))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207012_begin_time_wrong ({}) ....".format(begin_time))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确end_time值")
    @allure.testcase("FT-HTJK-207-013")
    @pytest.mark.parametrize("end_time, result",
                             [(2, {"status": 200, "code": 1, "msg": ""}),
                              (9999999999, {"status": 200, "code": 1, "msg": ""})],
                             ids=["end_time(最小值)", "end_time(最大值)"])
    def test_207013_end_time_correct(self, end_time, result):
        """ Test correct end_time values (最小值、最大值）(FT-HTJK-207-013).
        :param end_time: end_time parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207013_end_time_correct ({}) ....".format(end_time))
        service_order_id = None
        ...
        try:
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207013_end_time_correct ({}) ....".format(end_time))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误end_time值")
    @allure.testcase("FT-HTJK-207-014")
    @pytest.mark.parametrize("end_time, result",
                             [('1' * 1001, {"status": 400, "code": 0, "msg": ""}),
                             ...
                             ids=["end_time(超长值)", "end_time(0)", "end_time(最大值)",
                                  ...
                                  "end_time(过期)"])
    def test_207014_end_time_wrong(self, end_time, result):
        """ Test wrong end_time values (超长值、0、允许超大值、-1、1.5、超大值、字母、中文、特殊字符、数字字母、
        数字中文、数字特殊字符、空格、空、过期值）(FT-HTJK-207-014).
        :param end_time: end_time parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207014_end_time_wrong ({}) ....".format(end_time))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207014_end_time_wrong ({}) ....".format(end_time))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("检查次数时间空")
    @allure.testcase("FT-HTJK-207-015")
    @pytest.mark.parametrize("check_time, result",
                             [(' ', {"status": 200, "code": 1, "msg": ""}),
                              ('', {"status": 200, "code": 1, "msg": ""})],
                             ids=["check_time(空格)", "check_time(空)"])
    def test_207015_check_time_empty(self, check_time, result):
        """ Test check_time values (空格、空）(FT-HTJK-207-015).
        :param check_time: check_time parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207015_check_time_empty ({}) ....".format(check_time))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207015_check_time_empty ({}) ....".format(check_time))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确in_count值")
    @allure.testcase("FT-HTJK-207-016")
    @pytest.mark.parametrize("in_count, result",
                             [(1, {"status": 200, "code": 1, "msg": ""}),
                              (2147483647, {"status": 200, "code": 1, "msg": ""})],
                             ids=["in_count(最小值)", "in_count(最大值)"])
    def test_207016_in_count_correct(self, in_count, result):
        """ Test in_count values (最小值、最大值）(FT-HTJK-207-016).
        :param in_count: in_count parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207016_in_count_correct ({}) ....".format(in_count))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207016_in_count_correct ({}) ....".format(in_count))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误in_count值")
    @allure.testcase("FT-HTJK-207-017")
    @pytest.mark.parametrize("in_count, result",
    ...
    def test_207017_in_count_wrong(self, in_count, result):
        """ Test wrong in_count values (-1、5、-2147483649、2147483648、1.0、字母、中文、特殊字符、数字字母、数字中文、
            数字特殊字符、空格、空）(FT-HTJK-207-017).
        :param in_count: in_count parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207017_in_count_wrong ({}) ....".format(in_count))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207017_in_count_wrong ({}) ....".format(in_count))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("检查时间次数空")
    @allure.testcase("FT-HTJK-207-018")
    @pytest.mark.parametrize("in_count, result",
                             [(' ', {"status": 200, "code": 1, "msg": ""}),
                              ('', {"status": 200, "code": 1, "msg": ""})],
                             ids=["in_count(空格)", "in_count(空)"])
    def test_207018_in_count_empty(self, in_count, result):
        """ Test in_count values (空格、空）(FT-HTJK-207-018).
        :param in_count: in_count parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207018_in_count_empty ({}) ....".format(in_count))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207018_in_count_empty ({}) ....".format(in_count))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确service_unit值")
    @allure.testcase("FT-HTJK-207-019")
    ...
    def test_207019_service_unit_correct(self, service_unit, result):
        """ Test correct service_unit values (最大长度值、1.0、字母、中文、特殊字符、数字字母中文、数字字母特殊字符）(FT-HTJK-207-019).
        :param service_unit: service_unit parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207019_service_unit_correct ({}) ....".format(service_unit))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207019_service_unit_correct ({}) ....".format(service_unit))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误service_unit值")
    @allure.testcase("FT-HTJK-207-020")
    @pytest.mark.parametrize("service_unit, result",
                             [('1' * 256, {"code": 202999, "msg": "下单失败"}),
                              (' ', {"code": 101013, "msg": "service_unit值非法"}),
                              ('', {"code": 101013, "msg": "service_unit值非法"})],
                             ids=["service_unit(超长值)", "service_unit(空格)", "service_unit(空)"])
    def test_207020_service_unit_wrong(self, service_unit, result):
        """ Test wrong service_unit values (超长值、空格、空）(FT-HTJK-207-020).
        :param service_unit: service_unit parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207020_service_unit_wrong ({}) ....".format(service_unit))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207020_service_unit_wrong ({}) ....".format(service_unit))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确service_address值")
    @allure.testcase("FT-HTJK-207-021")
    @pytest.mark.parametrize("service_address, result",
                             [('1' * 100, {"code": 1, "msg": ""}),
                              ...
                              ('1a中', {"code": 1, "msg": ""}),
                              ('1a*', {"code": 1, "msg": ""})],
                             ids=["service_address(最大长度值)", "service_address(小数)", "service_address(字母)",
                                  "service_address(中文)",
                                  "service_address(特殊字符)", "service_address(数字字母中文)", "service_address(数字字母特殊字符)"])
    def test_207021_service_address_correct(self, service_address, result):
        """ Test correct service_address values (最大长度值、1.0、字母、中文、特殊字符、数字字母中文、数字字母特殊字符）(FT-HTJK-207-021).
        :param service_address: service_address parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207021_service_address_correct ({}) ....".format(service_address))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207021_service_address_correct ({}) ....".format(service_address))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误service_address值")
    @allure.testcase("FT-HTJK-207-022")
    @pytest.mark.parametrize("service_address, result",
                             [('1' * 256, {"code": 202999, "msg": "下单失败"}),
                              (' ', {"code": 101014, "msg": "service_address值非法"}),
                              ('', {"code": 101014, "msg": "service_address值非法"})],
                             ids=["service_address(超长值)", "service_address(空格)", "service_address(空)"])
    def test_207022_service_address_wrong(self, service_address, result):
        """ Test wrong service_address values (超长值、空格、空）(FT-HTJK-207-022).
        :param service_address: service_address parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207022_service_address_wrong ({}) ....".format(service_address))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207022_service_address_wrong ({}) ....".format(service_address))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("正确timestamp值")
    @allure.testcase("FT-HTJK-207-023")
    @pytest.mark.parametrize("timestamp, result",
                             [(get_timestamp() - 100, {"code": 1, "msg": ""}),
                              (get_timestamp() + 100, {"code": 1, "msg": ""})],
                             ids=["timestamp(最小值)", "timestamp(最大值)"])
    def test_207023_timestamp_correct(self, timestamp, result):
        """ Test correct timestamp values (最小值、最大值）(FT-HTJK-207-023).
        :param timestamp: timestamp parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207023_timestamp_correct ({}) ....".format(timestamp))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207023_timestamp_correct ({}) ....".format(timestamp))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("错误timestamp值")
    @allure.testcase("FT-HTJK-207-024")
    @pytest.mark.parametrize("timestamp, result",
    ...
    def test_207024_timestamp_wrong(self, timestamp, result):
        """ Test wrong timestamp values (1、9223372036854775807、0、-1、允许超小值、允许超大值、-9223372036854775809、9223372036854775808、1.0、
            字母、中文、特殊字符、数字字母、数字中文、数字特殊字符、空格、空）(FT-HTJK-207-024).
        :param timestamp: timestamp parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207024_timestamp_wrong ({}) ....".format(timestamp))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207024_timestamp_wrong ({}) ....".format(timestamp))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少system_id参数")
    @allure.testcase("FT-HTJK-207-025")
    def test_207025_no_system_id(self):
        """ Test create service order without system_id(FT-HTJK-207-025)."""
        self.logger.info(".... Start test_207025_no_system_id ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207025_no_system_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少business_order_id参数")
    @allure.testcase("FT-HTJK-207-026")
    def test_207026_no_business_order_id(self):
        """ Test create service order without business_order_id(FT-HTJK-207-026)."""
        self.logger.info(".... Start test_207026_no_business_order_id ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207026_no_business_order_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少system_code参数")
    @allure.testcase("FT-HTJK-207-027")
    def test_207027_no_system_code(self):
        """ Test create service order without system_code(FT-HTJK-207-027)."""
        self.logger.info(".... Start test_207027_no_system_code ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207027_no_system_code ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少features_id参数")
    @allure.testcase("FT-HTJK-207-028")
    def test_207028_no_features_id(self):
        """ Test create service order without features_id(FT-HTJK-207-028)."""
        self.logger.info(".... Start test_207028_no_features_id ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207028_no_features_id ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少device_ids参数")
    @allure.testcase("FT-HTJK-207-029")
    def test_207029_no_device_ids(self):
        """ Test create service order without device_ids(FT-HTJK-207-029)."""
        self.logger.info(".... Start test_207029_no_device_ids ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207029_no_device_ids ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少verify_condition_type参数")
    @allure.testcase("FT-HTJK-207-030")
    def test_207030_no_verify_condition_type(self):
        """ Test create service order without verify_condition_type(FT-HTJK-207-030)."""
        self.logger.info(".... Start test_207030_no_verify_condition_type ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207030_no_verify_condition_type ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少begin_time参数")
    @allure.testcase("FT-HTJK-207-031")
    ...
    def test_207031_no_begin_time(self, condition_type, result):
        """ Test create service order without begin time with condition type (1/2/3）(FT-HTJK-207-031).
        :param condition_type: condition_type parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207031_no_begin_time ({}) ....".format(condition_type))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207031_no_begin_time ({}) ....".format(condition_type))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少end_time参数")
    @allure.testcase("FT-HTJK-207-032")
    @pytest.mark.parametrize("condition_type, result",
                             [(1, {"status": 200, "code": 101006, "msg": "结束时间必须晚于开始时间"}),
                              (2, {"status": 200, "code": 1, "msg": ""}),
                              (3, {"status": 200, "code": 101006, "msg": "结束时间必须晚于开始时间"})],
                             ids=["condition_type(最大长度值)", "condition_type(小数)", "condition_type(字母)"])
    def test_207032_no_end_time(self, condition_type, result):
        """ Test create service order without end time with condition type (1/2/3）(FT-HTJK-207-032).
        :param condition_type: condition_type parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207032_no_end_time ({}) ....".format(condition_type))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207032_no_end_time ({}) ....".format(condition_type))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少in_count参数")
    @allure.testcase("FT-HTJK-207-033")
    @pytest.mark.parametrize("condition_type, result",
                             [(1, {"status": 200, "code": 1, "msg": ""}),
                              (2, {"status": 200, "code": 101011, "msg": "in_count值非法"}),
                              (3, {"status": 200, "code": 101011, "msg": "in_count值非法"})],
                             ids=["condition_type(最大长度值)", "condition_type(小数)", "condition_type(字母)"])
    def test_207033_no_in_count(self, condition_type, result):
        """ Test create service order without in_count with condition type (1/2/3）(FT-HTJK-207-033).
        :param condition_type: condition_type parameter value.
        :param result: expect result.
        """
        self.logger.info(".... Start test_207033_no_in_count ({}) ....".format(condition_type))
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id, "business_order_id": str(random.randint(100000, 1000000)),
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(
                ".... End test_207033_no_in_count ({}) ....".format(condition_type))
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少service_unit参数")
    @allure.testcase("FT-HTJK-207-034")
    def test_207034_no_service_unit(self):
        """ Test create service order without service_unit(FT-HTJK-207-034)."""
        self.logger.info(".... Start test_207034_no_service_unit ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207034_no_service_unit ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少service_address参数")
    @allure.testcase("FT-HTJK-207-035")
    def test_207035_no_service_address(self):
        """ Test create service order without service_address(FT-HTJK-207-035)."""
        self.logger.info(".... Start test_207035_no_service_address ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207035_no_service_address ....")
            self.logger.info("")

    @allure.severity("critical")
    @allure.story("缺少timestamp参数")
    @allure.testcase("FT-HTJK-207-036")
    def test_207036_no_timestamp(self):
        """ Test create service order without timestamp(FT-HTJK-207-036)."""
        self.logger.info(".... Start test_207036_no_timestamp ....")
        service_order_id = None
        try:
            with allure.step("teststep1: get parameters."):
                datas = {"system_id": self.system_id,
            ...
            if service_order_id:
                with allure.step("delete service order records"):
                    ...
                    allure.attach("delete result", str(delete_result))
                    self.logger.info("delete result: {0}".format(delete_result))
            self.logger.info(".... End test_207036_no_timestamp ....")
            self.logger.info("")
